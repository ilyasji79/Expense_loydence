 ...
 * 
 * Admin can view and manage all leave requests
 */
...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="leave-management.php" class="menu-item active"><i class="fas fa-calendar-minus"></i><span>Leave Management</span></a>
            <a href="payroll-management.php" class="menu-item"><i class="fas fa-money-bill-wave"></i><span>Payroll</span></a>
    ...
    <div class="main-content">
        ...
        <div class="filter-tabs">
            <a href="leave-management.php" class="btn <?php echo $status === '' ? 'active' : ''; ?>">All</a>
            <a href="leave-management.php?status=pending" class="btn <?php echo $status === 'pending' ? 'active' : ''; ?>">Pending
                <?php if ($pendingCount > 0): ?>
                    <span class="badge"><?php echo $pendingCount; ?></span>
                <?php endif; ?>
            </a>
            <a href="leave-management.php?status=approved" class="btn <?php echo $status === 'approved' ? 'active' : ''; ?>">Approved</a>
            <a href="leave-management.php?status=rejected" class="btn <?php echo $status === 'rejected' ? 'active' : ''; ?>">Rejected</a>
        </div>
